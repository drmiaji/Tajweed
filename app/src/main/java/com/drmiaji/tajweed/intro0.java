    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent right = new Intent(intro0.this, intro1.class);
                startActivity(right);
            }
        });

        TextView textView = findViewById(R.id.intro0);
        textView.setText(readTxt());
    }

    private String readTxt() {
        InputStream inputStream = getResources().openRawResource(R.raw.intro0);
